...
public class PlsEfsElement {
    ...
    private List<PlsEfsElement> children;
    ...
    public List<PlsEfsElement> getChildren() {
        if (children == null) {
    ...
    public void setChildren(List<PlsEfsElement> children) {
    ...
    public Double getPriorizedWeight() {
        return priorizedWeight;
    }
    ...
    public String toString() {
        return partNumber + " " + description1De + " " + description2De;
    }
}
