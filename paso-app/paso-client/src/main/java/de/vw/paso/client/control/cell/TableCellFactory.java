...
public class TableCellFactory<E, T> implements Callback<TableColumn<E, T>, TableCell<E, T>> { // NO_UCD (use default)

    private final StringConverter<T> converter;
    private final Class<T> dataType;

    public TableCellFactory(StringConverter<T> converter) { // NO_UCD (use default)
