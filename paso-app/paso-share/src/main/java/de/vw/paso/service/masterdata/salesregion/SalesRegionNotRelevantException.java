...
public class SalesRegionNotRelevantException extends AbstractServerValidationException {

  @Getter
  private final ModelImport modelImport;

  public SalesRegionNotRelevantException(String message,ModelImport modelImport) {
    super(message);
  ...
  public String getMessageKey() {
    return "validation.SalesRegionNotRelevant";
  }
}
