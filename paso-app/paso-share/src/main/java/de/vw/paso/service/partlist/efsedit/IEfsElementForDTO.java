...
public interface IEfsElementForDTO extends IPartListElement<Long> {

    Integer DELETED_FLAG = 1;
    Integer GAP_FLAG = 1;

    EfsElementDTO getParent();

    AbstractEfsElementMaraDTO getEfsElementMara();

    Integer getDeleted();

    List<EfsElementDTO> getChildren();
