...
@Setter
@NoArgsConstructor
public class CostGroupCompareRow implements ComparableRow<CostGroupCompareRow> {

    private String costGroupStr;
    private Map<Long, DataSet> dataSets = new HashMap<>();
    private List<CostGroupCompareRow> children = new ArrayList<>();
    private Map<Long, Map<ApCompareGroup, Double>> table = new HashMap<>();
    private boolean isSum = false;

    public CostGroupCompareRow(String costGroups) {
        this.costGroupStr = costGroups;
    }
    ...
    @Override
    public void addChildRow(CostGroupCompareRow row) {
        children.add(row);
    }
    ...
    public Map<ApCompareGroup, Double> getWeights(Long vehicleConfigId) {
        if (table.containsKey(vehicleConfigId)) {
            ...
            for (CostGroupCompareRow costGroupCompareRow : getChildren()) {
